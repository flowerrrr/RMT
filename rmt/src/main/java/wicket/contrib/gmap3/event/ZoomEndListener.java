...
public abstract class ZoomEndListener extends GEventListenerBehavior {
    ...
    protected void onEvent( AjaxRequestTarget target ) {
        ...
        int oldLevel = 0;
        int newLevel = 0;
        String oldZoomLevelParameter = request.getRequestParameters().getParameterValue( "argument0" ).toString();
        String newZoomLevelParameter = request.getRequestParameters().getParameterValue( "argument1" ).toString();
